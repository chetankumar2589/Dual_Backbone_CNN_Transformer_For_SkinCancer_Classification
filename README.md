...
# Enhanced Skin Cancer Classification System

Hybrid CNN-Transformer architecture achieving 87.93% accuracy with 32× model compression for deployable melanoma detection.
